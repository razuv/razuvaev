...
const hasLocalTv=Boolean(import.meta.glob('../pages/tv.vue')['../pages/tv.vue'])
    ...
    <header class="admin-header">
      ...
      <div class="admin-nav" :class="{'admin-nav--open':menuOpen}">
        <nav class="admin-links">
          <RouterLink class="pill" exact-active-class="pill--active" :to="{path:'/',query:{lang:activeLanguage}}" @click="menuOpen=false">Главная</RouterLink>
          <RouterLink class="pill" active-class="pill--active" :to="{path:'/cv',query:{lang:activeLanguage}}" @click="menuOpen=false">CV</RouterLink>
          <RouterLink class="pill" active-class="pill--active" :to="{path:'/footer',query:{lang:activeLanguage}}" @click="menuOpen=false">Футер</RouterLink>
          <RouterLink class="pill" active-class="pill--active" :to="{path:'/cases',query:{lang:activeLanguage}}" @click="menuOpen=false">Кейсы</RouterLink>
          <RouterLink class="pill" active-class="pill--active" to="/history" @click="menuOpen=false">История</RouterLink>
          <RouterLink v-if="hasLocalTv" class="pill" active-class="pill--active" to="/tv" @click="menuOpen=false">TV</RouterLink>
          <RouterLink class="pill" active-class="pill--active" :to="{path:'/statistics',query:{lang:activeLanguage}}" @click="menuOpen=false">Статистика</RouterLink>
        </nav>
